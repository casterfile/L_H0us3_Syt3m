...
namespace YoutubePlayer
{
    ...
    public class YTPlayer : MonoBehaviour
    {
        ...
        public async Task PrepareVideoAsync(string videoUrl = null, YoutubeDlOptions options = null, CancellationToken cancellationToken = default)
        {
            ...
            print("Address Location: " + VideoSource.Url);
            ...
            VideoPlayer.url = "https://proxy-webapp.herokuapp.com/" + rawUrl;
#else
             VideoPlayer.url = "" + rawUrl;
#endif
                print("Address Location: " + rawUrl);
            }
